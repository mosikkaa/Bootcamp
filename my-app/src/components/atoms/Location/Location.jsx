...
export function LocationV1() {
     return(
         <div className='flex gap-0.5 items-center'>
             <div className='flex gap-1 px-1 items-center py-0.5'>
             ...
             <div className='px-1 py-0.5 items-center flex items-center'>
...
export function LocationV2() {
    return(
        <div className='flex gap-0.5 items-center'>
            ...
            <div className='px-1 py-0.5 gap-1 flex items-center'>
